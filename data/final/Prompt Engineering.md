...
Model gemini-pro
PromptClassify movie reviews as positive, neutral or negative. Return
valid JSON:
Review: "Her" is a disturbing study revealing the direction
humanity is headed if AI is allowed to keep evolving,
unchecked. It's so disturbing I couldn't watch it.
...
Model gemini-pro
Prompt Write a one paragraph storyline for a new level of a firstperson shooter video game that is challenging and engaging.
...
Attempt 1**Step 1: Identify the purpose of the email.**
...
Attempt 24. **Absence of action request:** The email does not explicitly request any
...
Output
Attempt 3**Step 1: Identify the purpose of the email.**
...
Besides the prompt input format, consider experimenting with the output format. For noncreative tasks like extracting, selecting, parsing, ordering, ranking, or categorizing data try
...
15. Zhou, C., et al., 2023, Automatic  - Large Language Models are Human-Level Prompt
